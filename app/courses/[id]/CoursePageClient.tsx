...
export default function CoursePageClient({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: 13, color: 'var(--text-muted)', fontWeight: 500 }}>{lessons.length} lesson</span>
              </div>
